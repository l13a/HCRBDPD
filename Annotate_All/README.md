...
For the marker gene identification, we used [FindMarkers()](https://satijalab.org/seurat/reference/findmarkers) from Seurat. You may refer to the script we used to generate the marker gene lists in the '../scripts' folder.
